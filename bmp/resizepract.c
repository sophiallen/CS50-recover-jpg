...
int main(int argc, char* argv[])
{
    ...
    printf("triple is %d", sizeof(RGBTRIPLE));
    ...
    bi2.biSizeImage = -(bi2.biWidth*sizeof(RGBTRIPLE)+padding2)*bi2.biHeight;
     
    //modify the file header
    bf2.bfSize = -(bi2.biWidth*sizeof(RGBTRIPLE)+padding2)*bi2.biHeight + headersize;
